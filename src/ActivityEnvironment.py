...
#done = False
# while not done:
#     state, reward, done = activity_environment.step(activity_environment.SENSOR)

#activity_environment.step(activity_environment.VISION_ACTION)
#activity_environment.step(activity_environment.CAMERA)
# pred = activity_environment.step(action=('sensor', activity_environment.sns_x[0]))
# print(pred)

# sess = tf.Session()
# keras.backend.set_session(sess)
#
# sensor_agent = SensorAgent(model_weights='sensor_model.hdf5')
